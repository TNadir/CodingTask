...
namespace CodingSolution.Web.Components
{


    public static class SelectorComponentViewHelper
    {
        /// <summary>
        /// Create an HTML tree from a recursive collection of items
        /// </summary>
        public static SelectorComponentView<T> ComponentView<T>(this HtmlHelper html, IEnumerable<T> items)
        {
            return new SelectorComponentView<T>(html, items);
        }
    }
    ...
    /// </summary>
    public class SelectorComponentView<T> : IHtmlString
    {
        ...
        public SelectorComponentView(HtmlHelper html, IEnumerable<T> items)
        {
        ...
        /// </summary>
        public SelectorComponentView<T> ItemText(Func<T, string> selector)
        {
        ...
        /// </summary>
        public SelectorComponentView<T> ItemTemplate(Func<T, HelperResult> itemTemplate)
        {
        ...
        /// </summary>
        public SelectorComponentView<T> Children(Func<T, IEnumerable<T>> selector)
        {
            if (selector == null) throw new ArgumentNullException("selector");
        ...
        /// </summary>
        public SelectorComponentView<T> EmptyContent(string emptyContent)
        {
        ...
        /// </summary>
        public SelectorComponentView<T> HtmlAttributes(object htmlAttributes)
        {
        ...
        /// HTML attributes appended to the root ul node
        /// </summary>
        public SelectorComponentView<T> HtmlAttributes(IDictionary<string, object> htmlAttributes)
        {
        ...
        /// </summary>
        public SelectorComponentView<T> ChildrenHtmlAttributes(object htmlAttributes)
        {
        ...
        /// HTML attributes appended to the children items
        /// </summary>
        public SelectorComponentView<T> ChildrenHtmlAttributes(IDictionary<string, object> htmlAttributes)
        {
            if (htmlAttributes == null) throw new ArgumentNullException("htmlAttributes");
